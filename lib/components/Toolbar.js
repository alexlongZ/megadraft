...
var Toolbar = (_temp = _class = function (_Component) {
  ...
  _createClass(Toolbar, [{
    ...
    value: function componentDidUpdate() {
      ...
      if (this.props.shouldDisplayToolbarFn() && selection.rangeCount !== 0 && selection.getRangeAt(0) && !selection.isCollapsed && isDescendant(this.props.editor, selection.getRangeAt(0).commonAncestorContainer)) {
